...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiOperation(value = "find invention by date", notes = "", response = Object.class, authorizations = {
...
,@Context SecurityContext securityContext)
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid status value", response = Void.class) })
    public Response findInventionsByStatus(@ApiParam(value = "the status of the invention (finished or unfinished)",required=true, allowableValues="finished, unfinished") @QueryParam("status") List<String> status
,@Context SecurityContext securityContext)
    throws NotFoundException {
