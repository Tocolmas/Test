...
public abstract class EventApiService {
    ...
    public abstract Response findEventsByInvention( @NotNull List<String> invention,SecurityContext securityContext) throws NotFoundException;
    public abstract Response findEventsByInventor( @NotNull List<String> invention,SecurityContext securityContext) throws NotFoundException;
