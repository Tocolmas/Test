...
public class TestEvent {
	...
	public void findbyName() throws NotFoundException {
		...
		eve1.setName("Invention dla souris");
		eve1.setStartdate("15/05/1955");
		eve1.setEnddate("");
		eve1.getId();
	    ...
	    res=api.findEventsByName("Invention dla souris", null);
	...
	public void findbyDate() throws NotFoundException {
		...
		eve3.setStartdate("16/07/1855");
		eve3.setEnddate("");
		eve3.getId();
		System.out.println(eve3);
		EventApiService api = EventApiServiceFactory.getEventApi();
		Response res=api.addevent(eve3, null);
		res=api.eventfindByDate("16/07/1855", null);
