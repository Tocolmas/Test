 ...
 * Invention
 */
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaJerseyServerCodegen", date = "2022-02-19T09:33:27.588Z")public class Invention   {
  @JsonProperty("id")
  ...
  public Invention status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, photoUrls, tags, status, startdate, finsihdate);
  }
