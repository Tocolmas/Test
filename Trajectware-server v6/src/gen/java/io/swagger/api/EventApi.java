...
,@Context SecurityContext securityContext)
    ...
    public Response findEventsByInvention(@ApiParam(value = "Descriptions to filter by",required=true) @QueryParam("invention") List<String> invention
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.findEventsByInvention(invention,securityContext);
    }
    @GET
    @Path("/findByInventor")
    ...
    @io.swagger.annotations.ApiResponses(value = { 
        ...
        @io.swagger.annotations.ApiResponse(code = 400, message = "Invalid tag value", response = Void.class) })
    public Response findEventsByInventor(@ApiParam(value = "Descriptions to filter by",required=true) @QueryParam("invention") List<String> invention
,@Context SecurityContext securityContext)
    throws NotFoundException {
        return delegate.findEventsByInventor(invention,securityContext);
    }
    @GET
    @Path("/findByName")
